...
/**
 * Maps horizontal menu items to vertical menu format.
 * This is used when showing horizontal menu items in a vertical drawer on mobile.
 */
export const mapHorizontalToVerticalMenu = (children: ReactNode): ReactNode => {
  // Horizontal and vertical menu items use the same component API,
  // so we can just return the children as-is
  return children
}
